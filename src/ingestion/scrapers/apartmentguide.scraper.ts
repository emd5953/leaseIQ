...
/**
 * Scraper for ApartmentGuide listings
 */
export class ApartmentGuideScraper extends AbstractListingScraper {
  getSource(): ListingSource {
    return ListingSource.APARTMENT_GUIDE;
  }
  ...
  protected buildSearchUrl(config: ScrapeConfig): string {
    return 'https://www.apartmentguide.com/apartments/New-York/';
  }

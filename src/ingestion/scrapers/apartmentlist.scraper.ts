...
/**
 * Scraper for ApartmentList listings
 */
export class ApartmentListScraper extends AbstractListingScraper {
  getSource(): ListingSource {
    return ListingSource.APARTMENT_LIST;
  }
  ...
  protected buildSearchUrl(config: ScrapeConfig): string {
    return 'https://www.apartmentlist.com/ny/new-york';
  }

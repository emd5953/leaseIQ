...
/**
 * Scraper for Rentals.com listings
 */
export class RentalsComScraper extends AbstractListingScraper {
  getSource(): ListingSource {
    return ListingSource.RENTALS_COM;
  }
  ...
  protected buildSearchUrl(config: ScrapeConfig): string {
    return 'https://www.rentals.com/New-York/';
  }
